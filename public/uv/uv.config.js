...
(async () => {
    ...
    const currentHost = new URL(__uv$config.decodeUrl(location.pathname.replace(__uv$config.prefix, ""))).host
    if (__uv$config.decodeUrl(location.pathname.replace(__uv$config.prefix, "")).includes("porn")) {
        alert("freak")
